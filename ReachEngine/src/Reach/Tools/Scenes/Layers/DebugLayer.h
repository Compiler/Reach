...
namespace reach{
    ...
    class DebugLayer : public Layer{
        ...
        explicit DebugLayer(){
                ...
                auto ee = addEntity(800, 500, glm::vec2(75), 0, 0, 1, REACH_INTERNAL_TEXTURE("wall.jpg"), 3, true);
                auto esdae = addEntity(800, 500, glm::vec2(175), 0, 0, 1, REACH_INTERNAL_TEXTURE("wall.jpg"), 3, true);
